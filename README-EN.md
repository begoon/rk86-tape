...
- **`docs/index.html`** — self-contained browser visualizer (live:
  <https://begoon.github.io/rk86-tape>). Drag a `.wav` file onto it to see the
  waveform, every bit transition, byte boundaries, and the structural regions
  (prologue / sync / header / data / gap / 2nd sync / checksum). No build step.
